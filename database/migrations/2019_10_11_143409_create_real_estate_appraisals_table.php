...
class CreateRealEstateAppraisalsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('real_estate_appraisals', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('real_estate_appraisals');
    }
}
